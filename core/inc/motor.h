...
struct MotorDriver_t {
  MotorError_t (*init)(struct Motor_t *motor,
                       struct MotorConfig_t *config); /**< Motor initializer */
  ...
  MotorError_t (*set_velocity)(struct Motor_t *motor,
                               float velocity); /**< Update velocity setpoint */
  MotorError_t (*set_position)(struct Motor_t *motor,
                               float position);                    /**< Update position setpoint */
